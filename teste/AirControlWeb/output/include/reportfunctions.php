...
function GetUserGroups() {
	...
	$qResult = $grConnection->query("select ".$grConnection->addFieldWrappers("GroupID")
		.", ".$grConnection->addFieldWrappers("Label")." from ".$grConnection->addTableWrappers("aircontrolweb_dyperuggroups")
...
function getCaptionTable($table)
{
	...
	if($table=="tb_setpoint_email")
	{
		return "Tb Setpoint Email";
	}
	if($table=="aircontrolweb_users")
	{
		return "Aircontrolweb Users";
	}
	if($table=="tb_monitoramento")
	{
		return "Tb Monitoramento";
	}
	if($table=="tb_reference")
	{
		return "Tb Reference";
	...
	if($table=="tb_setpoint_bloqueia")
	{
		return "Tb Setpoint Bloqueia";
	}
	if($table=="tb_setpoint_sms")
	{
		return "Tb Setpoint Sms";
	}
	if($table=="tb_status")
	{
		return "Tb Status";
	...
	if($table=="12horas Chart")
	{
		return "12horas Chart";
	}
	if($table=="24horas Chart")
	{
		return "24horas Chart";
	}
	if($table=="admin_rights")
	{
		return "Admin Rights";
	...
	if($table=="vwv_analise_temp_maximo_acima")
	{
		return "Vwv Analise Temp Maximo Acima";
	}
	if($table=="vwv_analise_temp_minima_abaixo")
	{
		return "Vwv Analise Temp Minima Abaixo";
	}
	if($table=="vwv_monitoramento_por_periodo")
	{
		return "Vwv Monitoramento Por Periodo";
	}
	if($table=="vwv_monitoramento_por_periodo_leitura_max_min_med")
	{
		return "Vwv Monitoramento Por Periodo Leitura Max Min Med";
	}
	if($table=="vwv_monitoramento_por_periodo_leitura_maxima")
	{
		return "Vwv Monitoramento Por Periodo Leitura Maxima";
	}
	if($table=="vwv_monitoramento_por_periodo_leitura_minima")
	{
		return "Vwv Monitoramento Por Periodo Leitura Minima";
	}
	if($table=="vwv_tag_user")
	{
		return "Vwv Tag User";
...
function GetTablesListReport()
{
	...
	if($securityFlag)
	{
		$value="vwv_analise_temp_maximo_acima";
		if(substr($value,-6)!="_audit" && substr($value,-8)!="_locking" && substr($value,-9)!="_ugrights" && substr($value,-9)!="_uggroups" 
		&& substr($value,-10)!="_ugmembers" && $value!="admin_rights" && $value!="admin_users"
		&& $value!="admin_members" && $value!="webreports" && $value!="webreport_style" && $value!="webreport_settings" && $value!="webreport_admin" && $value!="webreport_sql")
	...
	if($securityFlag)
	{
		$value="vwv_analise_temp_minima_abaixo";
		if(substr($value,-6)!="_audit" && substr($value,-8)!="_locking" && substr($value,-9)!="_ugrights" && substr($value,-9)!="_uggroups" 
		&& substr($value,-10)!="_ugmembers" && $value!="admin_rights" && $value!="admin_users"
		&& $value!="admin_members" && $value!="webreports" && $value!="webreport_style" && $value!="webreport_settings" && $value!="webreport_admin" && $value!="webreport_sql")
	...
	if($securityFlag)
	{
		$value="vwv_monitoramento_por_periodo";
		if(substr($value,-6)!="_audit" && substr($value,-8)!="_locking" && substr($value,-9)!="_ugrights" && substr($value,-9)!="_uggroups" 
		&& substr($value,-10)!="_ugmembers" && $value!="admin_rights" && $value!="admin_users"
		&& $value!="admin_members" && $value!="webreports" && $value!="webreport_style" && $value!="webreport_settings" && $value!="webreport_admin" && $value!="webreport_sql")
	...
	if($securityFlag)
	{
		$value="vwv_monitoramento_por_periodo_leitura_max_min_med";
		if(substr($value,-6)!="_audit" && substr($value,-8)!="_locking" && substr($value,-9)!="_ugrights" && substr($value,-9)!="_uggroups" 
		&& substr($value,-10)!="_ugmembers" && $value!="admin_rights" && $value!="admin_users"
		&& $value!="admin_members" && $value!="webreports" && $value!="webreport_style" && $value!="webreport_settings" && $value!="webreport_admin" && $value!="webreport_sql")
	...
	if($securityFlag)
	{
		$value="vwv_monitoramento_por_periodo_leitura_maxima";
		if(substr($value,-6)!="_audit" && substr($value,-8)!="_locking" && substr($value,-9)!="_ugrights" && substr($value,-9)!="_uggroups" 
		&& substr($value,-10)!="_ugmembers" && $value!="admin_rights" && $value!="admin_users"
		&& $value!="admin_members" && $value!="webreports" && $value!="webreport_style" && $value!="webreport_settings" && $value!="webreport_admin" && $value!="webreport_sql")
	...
	if($securityFlag)
	{
		$value="vwv_monitoramento_por_periodo_leitura_minima";
		if(substr($value,-6)!="_audit" && substr($value,-8)!="_locking" && substr($value,-9)!="_ugrights" && substr($value,-9)!="_uggroups" 
		&& substr($value,-10)!="_ugmembers" && $value!="admin_rights" && $value!="admin_users"
		&& $value!="admin_members" && $value!="webreports" && $value!="webreport_style" && $value!="webreport_settings" && $value!="webreport_admin" && $value!="webreport_sql")
