...
$tdatavwv_tag_user[".pagesByType"] = my_json_decode( "{\"list\":[\"list\"],\"search\":[\"search\"]}" );
$tdatavwv_tag_user[".originalPagesByType"] = $tdatavwv_tag_user[".pagesByType"];
$tdatavwv_tag_user[".pages"] = types2pages( my_json_decode( "{\"list\":[\"list\"],\"search\":[\"search\"]}" ) );
$tdatavwv_tag_user[".originalPages"] = $tdatavwv_tag_user[".pages"];
$tdatavwv_tag_user[".defaultPages"] = my_json_decode( "{\"list\":\"list\",\"search\":\"search\"}" );
...
$tdatavwv_tag_user[".badgeColor"] = "CFAE83";
