...
$tdataadmin_members[".OriginalTable"] = "aircontrolweb_users";
...
if(mlang_getcurrentlang()=="Portuguese(Brazil)")
{
	...
	$placeHoldersadmin_members["Portuguese(Brazil)"]["ID"] = "";
	$fieldLabelsadmin_members["Portuguese(Brazil)"]["username"] = "Username";
	$fieldToolTipsadmin_members["Portuguese(Brazil)"]["username"] = "";
	$placeHoldersadmin_members["Portuguese(Brazil)"]["username"] = "";
	$fieldLabelsadmin_members["Portuguese(Brazil)"]["password"] = "Password";
	$fieldToolTipsadmin_members["Portuguese(Brazil)"]["password"] = "";
	$placeHoldersadmin_members["Portuguese(Brazil)"]["password"] = "";
	$fieldLabelsadmin_members["Portuguese(Brazil)"]["email"] = "Email";
	$fieldToolTipsadmin_members["Portuguese(Brazil)"]["email"] = "";
	$placeHoldersadmin_members["Portuguese(Brazil)"]["email"] = "";
	$fieldLabelsadmin_members["Portuguese(Brazil)"]["fullname"] = "Fullname";
	$fieldToolTipsadmin_members["Portuguese(Brazil)"]["fullname"] = "";
	$placeHoldersadmin_members["Portuguese(Brazil)"]["fullname"] = "";
	$fieldLabelsadmin_members["Portuguese(Brazil)"]["groupid"] = "Groupid";
	$fieldToolTipsadmin_members["Portuguese(Brazil)"]["groupid"] = "";
	$placeHoldersadmin_members["Portuguese(Brazil)"]["groupid"] = "";
	$fieldLabelsadmin_members["Portuguese(Brazil)"]["active"] = "Active";
	$fieldToolTipsadmin_members["Portuguese(Brazil)"]["active"] = "";
	$placeHoldersadmin_members["Portuguese(Brazil)"]["active"] = "";
	$fieldLabelsadmin_members["Portuguese(Brazil)"]["ext_security_id"] = "Ext Security Id";
	$fieldToolTipsadmin_members["Portuguese(Brazil)"]["ext_security_id"] = "";
	$placeHoldersadmin_members["Portuguese(Brazil)"]["ext_security_id"] = "";
...
$tdataadmin_members[".connId"] = "db9f9deaairwebatMYSQL5014site4";


$tdataadmin_members[".strOriginalTableName"] = "aircontrolweb_users";
...
$tdataadmin_members[".sqlFrom"] = "FROM aircontrolweb_users";
