...
if (@$_SESSION['webcharts']['tables'][0] != "") {
	...
	$xt->assign("chart_table",", "."Tabela".": ".$stable);
} else {
				...
				success: function(msg){
					if ( msg == "OK" ) {
						...
						if(this.id == "savebtn")
							...
							$("#alert").html("<p>'."Alguns problemas aparecem durante a prévia".'</p>").dialog("open");
					}
				},
				error: function() {
					if(this.id == "savebtn")
...
$xt->assign("stacked", "<span id=\"td_stacked\" style=\"visibility:hidden\"><input type=\"checkbox\" ".$sstacked_checked." id=\"sstacked\" name=\"sstacked\" />&nbsp;"."100% Empilhados"."</span>");
...
if ($_SESSION['webcharts']['chart_type']['type']=="2d_column" || $_SESSION['webcharts']['chart_type']['type']=="2d_bar" || $_SESSION['webcharts']['chart_type']['type']=="area") 
	$xt->assign("chart_is_stacked","<input type=\"checkbox\" ".$isstacked_checked." id=\"isstacked\" name=\"isstacked\">&nbsp;"."Gráfico empilhado");
else 
...
if ( preg_match( "/line/i", $_SESSION['webcharts']['chart_type']['type'] ) ) {
	$xt->assign("line", "&nbsp;&nbsp;&nbsp;&nbsp;"."Linha"." <select name=\"linestyle\" id=\"linestyle\">
...
if ( preg_match( "/gauge/i", $_SESSION['webcharts']['chart_type']['type'] ) ) {
	$xt->assign("gauge", "Aferição"." <select name=\"gaugestyle\" id=\"gaugestyle\">
