...
//		return $this->getTableData(".showSimpleSearchOptions");
	...
	{
		return new ProjectSettings("aircontrolweb_users", PAGE_LIST);
	}
...
function fillProjectEntites()
{
	...
	$projectEntities[ "aircontrolweb_users" ] = array( "url" => "aircontrolweb_users", "type" => 0 );
	$projectEntitiesReverse[ "aircontrolweb_users" ] = "aircontrolweb_users";
	...
	$projectEntities[ "tb_reference" ] = array( "url" => "tb_reference", "type" => 0 );
	$projectEntitiesReverse[ "tb_reference" ] = "tb_reference";
	...
	$projectEntities[ "tb_status" ] = array( "url" => "tb_status", "type" => 0 );
	$projectEntitiesReverse[ "tb_status" ] = "tb_status";
	$projectEntities[ "tb_ticket" ] = array( "url" => "tb_ticket", "type" => 0 );
	$projectEntitiesReverse[ "tb_ticket" ] = "tb_ticket";
	$projectEntities[ "tb_controle" ] = array( "url" => "tb_controle", "type" => 0 );
	$projectEntitiesReverse[ "tb_controle" ] = "tb_controle";
	$projectEntities[ "tb_agendamento" ] = array( "url" => "tb_agendamento", "type" => 0 );
	$projectEntitiesReverse[ "tb_agendamento" ] = "tb_agendamento";
