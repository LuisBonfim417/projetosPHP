...
class Chart
{
	...
	protected function isProjectDB()
	{
		...
		if("tb_setpoing" == $this->chrt_array['tables'][0])
			return true;
		if("tb_setpoint_email" == $this->chrt_array['tables'][0])
			return true;
		if("aircontrolweb_users" == $this->chrt_array['tables'][0])
			return true;
		if("tb_monitoramento" == $this->chrt_array['tables'][0])
			return true;
		if("tb_reference" == $this->chrt_array['tables'][0])
			return true;
		if("tb_setpoint_bloqueia" == $this->chrt_array['tables'][0])
			return true;
		if("tb_setpoint_sms" == $this->chrt_array['tables'][0])
			return true;
		if("tb_status" == $this->chrt_array['tables'][0])
			return true;
		if("tb_ticket" == $this->chrt_array['tables'][0])
			return true;
		if("tb_controle" == $this->chrt_array['tables'][0])
			return true;
		if("tb_agendamento" == $this->chrt_array['tables'][0])
			return true;
		if("24horas" == $this->chrt_array['tables'][0])
			return true;
		if("12horas" == $this->chrt_array['tables'][0])
			return true;
		if("24horas" == $this->chrt_array['tables'][0])
			return true;
		if("aircontrolweb_dyperugrights" == $this->chrt_array['tables'][0])
			return true;
		if("aircontrolweb_users" == $this->chrt_array['tables'][0])
			return true;
		if("aircontrolweb_users" == $this->chrt_array['tables'][0])
			return true;
		if("9horas" == $this->chrt_array['tables'][0])
			return true;
		if("6horas" == $this->chrt_array['tables'][0])
			return true;
		if("3horas" == $this->chrt_array['tables'][0])
			return true;
		if("12horas" == $this->chrt_array['tables'][0])
			return true;
		if("hoje" == $this->chrt_array['tables'][0])
			return true;
		if("vwv_analise_temp_maximo_acima" == $this->chrt_array['tables'][0])
			return true;
		if("vwv_analise_temp_minima_abaixo" == $this->chrt_array['tables'][0])
			return true;
		if("vwv_monitoramento_por_periodo" == $this->chrt_array['tables'][0])
			return true;
		if("vwv_monitoramento_por_periodo_leitura_max_min_med" == $this->chrt_array['tables'][0])
			return true;
		if("vwv_monitoramento_por_periodo_leitura_maxima" == $this->chrt_array['tables'][0])
			return true;
		if("vwv_monitoramento_por_periodo_leitura_minima" == $this->chrt_array['tables'][0])
			return true;
		if("vwv_tag_user" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
