...
require_once("include/vwv_monitoramento_por_periodo_leitura_maxima_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "vwv_monitoramento_por_periodo_leitura_maxima" );
