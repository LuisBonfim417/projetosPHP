...
$(document).ready(function(){
	...
	$("#addrel_btn").click(function(){
		...
		if ( tbl_left == -1 ) {
			$("#alert").html("<p>'."Selecionar tabela da esquerda".'</p>").dialog("open");
			return;
		}
		if ( tbl_right == -1 ) {
			$("#alert").html("<p>'."Selecionar tabela da direita".'</p>").dialog("open");
			return;
		}
		...
		if (relation_stack[rel_txt] != undefined) {
			$("#alert").html("<p>'."Um relacionamento com os parâmetros selecionados já existe".'</p>").dialog("open");
			return;
		}		
	...
	$("#remrel_btn").click(function(){
		...
		if ($("#rel_list").children(":selected").length > 0) {
			...
			$("#alert").html("<p>'."Selecionar o relacionamento que deseja remover".'</p>").dialog("open");
			return;
		}
	});
