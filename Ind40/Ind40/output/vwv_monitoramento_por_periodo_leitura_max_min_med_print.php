...
require_once("include/vwv_monitoramento_por_periodo_leitura_max_min_med_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "vwv_monitoramento_por_periodo_leitura_max_min_med" );
