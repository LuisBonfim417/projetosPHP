...
require_once("include/vwv_monitoramento_por_periodo_leitura_max_min_med_chart_variables.php");
...
$params['shortTableName'] = 'vwv_monitoramento_por_periodo_leitura_max_min_med_chart';
