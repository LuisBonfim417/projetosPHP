...
$pageMask[$table] = $mask;
$tables[$table] = array("ind40_users", " " . "Ind40 Users");
$table = "hoje Chart";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
...
$pageMask[$table] = $mask;
$tables[$table] = array("hoje_chart", " " . "Hoje Chart");
$table = "9horas Chart";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
...
$pageMask[$table] = $mask;
$tables[$table] = array("9horas_chart", " " . "9horas Chart");
$table = "6horas Chart";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
...
$pageMask[$table] = $mask;
$tables[$table] = array("6horas_chart", " " . "6horas Chart");
$table = "3horas Chart";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
...
$pageMask[$table] = $mask;
$tables[$table] = array("3horas_chart", " " . "3horas Chart");
$table = "12horas Chart";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
...
$pageMask[$table] = $mask;
$tables[$table] = array("vwv_monitoramento_por_periodo_leitura_max_min_med_chart", " " . "Vwv Monitoramento Por Periodo Leitura Max Min Med Chart");
