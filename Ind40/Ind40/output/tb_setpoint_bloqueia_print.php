...
require_once("include/tb_setpoint_bloqueia_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "tb_setpoint_bloqueia" );
