...
$nonAdminTablesArr[] = "tb_setpoing";
$nonAdminTablesArr[] = "tb_setpoint_bloqueia";
$nonAdminTablesArr[] = "tb_setpoint_email";
$nonAdminTablesArr[] = "tb_setpoint_sms";
$nonAdminTablesArr[] = "tb_monitoramento";
$nonAdminTablesArr[] = "vwv_analise_temp_maximo_acima";
$nonAdminTablesArr[] = "vwv_analise_temp_minima_abaixo";
$nonAdminTablesArr[] = "vwv_monitoramento_por_periodo";
$nonAdminTablesArr[] = "vwv_monitoramento_por_periodo_leitura_max_min_med";
$nonAdminTablesArr[] = "vwv_monitoramento_por_periodo_leitura_maxima";
$nonAdminTablesArr[] = "vwv_monitoramento_por_periodo_leitura_minima";
$nonAdminTablesArr[] = "vwv_tag_user";
$nonAdminTablesArr[] = "12horas";
$nonAdminTablesArr[] = "24horas";
$nonAdminTablesArr[] = "3horas";
$nonAdminTablesArr[] = "6horas";
$nonAdminTablesArr[] = "9horas";
$nonAdminTablesArr[] = "hoje";
$nonAdminTablesArr[] = "ind40_users";
$nonAdminTablesArr[] = "hoje Chart";
$nonAdminTablesArr[] = "9horas Chart";
$nonAdminTablesArr[] = "6horas Chart";
$nonAdminTablesArr[] = "3horas Chart";
$nonAdminTablesArr[] = "12horas Chart";
$nonAdminTablesArr[] = "24horas Chart";
$nonAdminTablesArr[] = "vwv_monitoramento_por_periodo_leitura_max_min_med Chart";
...
$wGroupTableName = $ug_connection->addTableWrappers( "aircontrolweb_dyperuggroups" );
...
switch(postvalue("a"))
{
	...
	case "del":
		...
		$sql = "delete from ". $ug_connection->addTableWrappers( "aircontrolweb_dyperugrights" ) 
			." where ". $ug_connection->addFieldWrappers( "GroupID" ) ."=".(postvalue_number("id"));
		$ug_connection->exec( $sql );
		
		$sql = "delete from ".$ug_connection->addTableWrappers( "aircontrolweb_dyperugmembers" ) 
			." where ". $ug_connection->addFieldWrappers( "GroupID" ) ."=".(postvalue_number("id"));
		$ug_connection->exec( $sql );
	...
	case 'saveRights':
		...
		{	
			...
			$wRightsTableName = $ug_connection->addTableWrappers( "aircontrolweb_dyperugrights" );
