...
class XTempl_Base
{
	 ...
	 function __construct( $hideAddedCharts = false )
	{
		...
		{
			$this->assign_function("hoje_chart_chart","xt_showchart",
			array(
				"chartName"=>"hoje_chart",
				"table"=>"hoje Chart",
				"ctype"=>"Line"));
			$this->assign_function("9horas_chart_chart","xt_showchart",
			array(
				"chartName"=>"9horas_chart",
				"table"=>"9horas Chart",
				"ctype"=>"Line"));
			$this->assign_function("6horas_chart_chart","xt_showchart",
			array(
				"chartName"=>"6horas_chart",
				"table"=>"6horas Chart",
				"ctype"=>"Line"));
			$this->assign_function("3horas_chart_chart","xt_showchart",
			array(
				"chartName"=>"3horas_chart",
				"table"=>"3horas Chart",
				"ctype"=>"Line"));
			$this->assign_function("12horas_chart_chart","xt_showchart",
			array(
				"chartName"=>"12horas_chart",
				"table"=>"12horas Chart",
				"ctype"=>"Line"));
			$this->assign_function("24horas_chart_chart","xt_showchart",
			array(
				"chartName"=>"24horas_chart",
				"table"=>"24horas Chart",
				"ctype"=>"Line"));
			$this->assign_function("vwv_monitoramento_por_periodo_leitura_max_min_med_chart_chart","xt_showchart",
			array(
				"chartName"=>"vwv_monitoramento_por_periodo_leitura_max_min_med_chart",
