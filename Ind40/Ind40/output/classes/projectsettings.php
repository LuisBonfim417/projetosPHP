...
//		return $this->getTableData(".showSimpleSearchOptions");
	...
	{
		return new ProjectSettings("ind40_users", PAGE_LIST);
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "tb_setpoing" ] = array( "url" => "tb_setpoing", "type" => 0 );
	$projectEntitiesReverse[ "tb_setpoing" ] = "tb_setpoing";
	$projectEntities[ "tb_setpoint_bloqueia" ] = array( "url" => "tb_setpoint_bloqueia", "type" => 0 );
	$projectEntitiesReverse[ "tb_setpoint_bloqueia" ] = "tb_setpoint_bloqueia";
	$projectEntities[ "tb_setpoint_email" ] = array( "url" => "tb_setpoint_email", "type" => 0 );
	$projectEntitiesReverse[ "tb_setpoint_email" ] = "tb_setpoint_email";
	$projectEntities[ "tb_setpoint_sms" ] = array( "url" => "tb_setpoint_sms", "type" => 0 );
	$projectEntitiesReverse[ "tb_setpoint_sms" ] = "tb_setpoint_sms";
	$projectEntities[ "tb_monitoramento" ] = array( "url" => "tb_monitoramento", "type" => 0 );
	$projectEntitiesReverse[ "tb_monitoramento" ] = "tb_monitoramento";
	$projectEntities[ "vwv_analise_temp_maximo_acima" ] = array( "url" => "vwv_analise_temp_maximo_acima", "type" => 0 );
	$projectEntitiesReverse[ "vwv_analise_temp_maximo_acima" ] = "vwv_analise_temp_maximo_acima";
	$projectEntities[ "vwv_analise_temp_minima_abaixo" ] = array( "url" => "vwv_analise_temp_minima_abaixo", "type" => 0 );
	$projectEntitiesReverse[ "vwv_analise_temp_minima_abaixo" ] = "vwv_analise_temp_minima_abaixo";
	$projectEntities[ "vwv_monitoramento_por_periodo" ] = array( "url" => "vwv_monitoramento_por_periodo", "type" => 0 );
	$projectEntitiesReverse[ "vwv_monitoramento_por_periodo" ] = "vwv_monitoramento_por_periodo";
	$projectEntities[ "vwv_monitoramento_por_periodo_leitura_max_min_med" ] = array( "url" => "vwv_monitoramento_por_periodo_leitura_max_min_med", "type" => 0 );
	$projectEntitiesReverse[ "vwv_monitoramento_por_periodo_leitura_max_min_med" ] = "vwv_monitoramento_por_periodo_leitura_max_min_med";
	$projectEntities[ "vwv_monitoramento_por_periodo_leitura_maxima" ] = array( "url" => "vwv_monitoramento_por_periodo_leitura_maxima", "type" => 0 );
	$projectEntitiesReverse[ "vwv_monitoramento_por_periodo_leitura_maxima" ] = "vwv_monitoramento_por_periodo_leitura_maxima";
	$projectEntities[ "vwv_monitoramento_por_periodo_leitura_minima" ] = array( "url" => "vwv_monitoramento_por_periodo_leitura_minima", "type" => 0 );
	$projectEntitiesReverse[ "vwv_monitoramento_por_periodo_leitura_minima" ] = "vwv_monitoramento_por_periodo_leitura_minima";
	$projectEntities[ "vwv_tag_user" ] = array( "url" => "vwv_tag_user", "type" => 0 );
	$projectEntitiesReverse[ "vwv_tag_user" ] = "vwv_tag_user";
	$projectEntities[ "12horas" ] = array( "url" => "12horas", "type" => 0 );
	$projectEntitiesReverse[ "12horas" ] = "12horas";
	$projectEntities[ "24horas" ] = array( "url" => "24horas", "type" => 0 );
	$projectEntitiesReverse[ "24horas" ] = "24horas";
	$projectEntities[ "3horas" ] = array( "url" => "3horas", "type" => 0 );
	$projectEntitiesReverse[ "3horas" ] = "3horas";
	$projectEntities[ "6horas" ] = array( "url" => "6horas", "type" => 0 );
	$projectEntitiesReverse[ "6horas" ] = "6horas";
	$projectEntities[ "9horas" ] = array( "url" => "9horas", "type" => 0 );
	$projectEntitiesReverse[ "9horas" ] = "9horas";
	$projectEntities[ "hoje" ] = array( "url" => "hoje", "type" => 0 );
	$projectEntitiesReverse[ "hoje" ] = "hoje";
	$projectEntities[ "ind40_users" ] = array( "url" => "ind40_users", "type" => 0 );
	$projectEntitiesReverse[ "ind40_users" ] = "ind40_users";
	...
	$projectEntities[ "hoje Chart" ] = array( "url" => "hoje_chart", "type" => 3 );
	$projectEntitiesReverse[ "hoje_chart" ] = "hoje Chart";
	$projectEntities[ "9horas Chart" ] = array( "url" => "9horas_chart", "type" => 3 );
	$projectEntitiesReverse[ "9horas_chart" ] = "9horas Chart";
	$projectEntities[ "6horas Chart" ] = array( "url" => "6horas_chart", "type" => 3 );
	$projectEntitiesReverse[ "6horas_chart" ] = "6horas Chart";
	$projectEntities[ "3horas Chart" ] = array( "url" => "3horas_chart", "type" => 3 );
	$projectEntitiesReverse[ "3horas_chart" ] = "3horas Chart";
	$projectEntities[ "12horas Chart" ] = array( "url" => "12horas_chart", "type" => 3 );
	$projectEntitiesReverse[ "12horas_chart" ] = "12horas Chart";
	$projectEntities[ "24horas Chart" ] = array( "url" => "24horas_chart", "type" => 3 );
	$projectEntitiesReverse[ "24horas_chart" ] = "24horas Chart";
	$projectEntities[ "vwv_monitoramento_por_periodo_leitura_max_min_med Chart" ] = array( "url" => "vwv_monitoramento_por_periodo_leitura_max_min_med_chart", "type" => 3 );
	$projectEntitiesReverse[ "vwv_monitoramento_por_periodo_leitura_max_min_med_chart" ] = "vwv_monitoramento_por_periodo_leitura_max_min_med Chart";
}
