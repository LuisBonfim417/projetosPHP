...
class DB
{
	...
	protected static function _fillTablesList()
	{
		...
		if( "db9f9deaairwebatMYSQL5014site4" == $conn->connId )
		{
			...
			$dalTables[$conn->connId][] = array("name" => "ind40_users", "varname" => "db9f9deaairwebatMYSQL5014site4__ind40_users", "altvarname" => "ind40_users", "connId" => "db9f9deaairwebatMYSQL5014site4", "schema" => "", "connName" => "db_9f9dea_airweb at MYSQL5014.");
