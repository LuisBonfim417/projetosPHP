...
class ConnectionManager
{
	...
	{
		return $this->byId( "db9f9deaairwebatMYSQL5014site4" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "db9f9deaairwebatMYSQL5014site4";
		$data["connName"] = "db_9f9dea_airweb at MYSQL5014.";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;MYSQL5014.site4now.net;9f9dea_airweb;Bidy061989;3306;db_9f9dea_airweb;;1"; //currently unused

		$this->_connectionsIdByName["db_9f9dea_airweb at MYSQL5014."] = "db9f9deaairwebatMYSQL5014site4";
		
		$data["connInfo"] = array();
		$data["ODBCUID"] = "9f9dea_airweb";
		$data["ODBCPWD"] = "Bidy061989";
		$data["leftWrap"] = "`";
		$data["rightWrap"] = "`";
		...
		$data["connInfo"][0] = "MYSQL5014.site4now.net";
		$data["connInfo"][1] = "9f9dea_airweb";
		$data["connInfo"][2] = "Bidy061989";
		$data["connInfo"][3] = "3306";
		$data["connInfo"][4] = "db_9f9dea_airweb";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=MYSQL5014.site4now.net;Uid=9f9dea_airweb;Pwd=Bidy061989;Port=3306;Database=db_9f9dea_airweb;OPTION=3";
		// encription set
		...
		$connectionsData["db9f9deaairwebatMYSQL5014site4"] = $data;
	...
	{
		$connectionsIds = array();
		$connectionsIds["tb_setpoing"] = "db9f9deaairwebatMYSQL5014site4";
		$connectionsIds["tb_setpoint_bloqueia"] = "db9f9deaairwebatMYSQL5014site4";
		$connectionsIds["tb_setpoint_email"] = "db9f9deaairwebatMYSQL5014site4";
		$connectionsIds["tb_setpoint_sms"] = "db9f9deaairwebatMYSQL5014site4";
		$connectionsIds["tb_monitoramento"] = "db9f9deaairwebatMYSQL5014site4";
		$connectionsIds["vwv_analise_temp_maximo_acima"] = "db9f9deaairwebatMYSQL5014site4";
		$connectionsIds["vwv_analise_temp_minima_abaixo"] = "db9f9deaairwebatMYSQL5014site4";
		$connectionsIds["vwv_monitoramento_por_periodo"] = "db9f9deaairwebatMYSQL5014site4";
		$connectionsIds["vwv_monitoramento_por_periodo_leitura_max_min_med"] = "db9f9deaairwebatMYSQL5014site4";
		$connectionsIds["vwv_monitoramento_por_periodo_leitura_maxima"] = "db9f9deaairwebatMYSQL5014site4";
		$connectionsIds["vwv_monitoramento_por_periodo_leitura_minima"] = "db9f9deaairwebatMYSQL5014site4";
		$connectionsIds["vwv_tag_user"] = "db9f9deaairwebatMYSQL5014site4";
		$connectionsIds["12horas"] = "db9f9deaairwebatMYSQL5014site4";
		$connectionsIds["24horas"] = "db9f9deaairwebatMYSQL5014site4";
		$connectionsIds["3horas"] = "db9f9deaairwebatMYSQL5014site4";
		$connectionsIds["6horas"] = "db9f9deaairwebatMYSQL5014site4";
		$connectionsIds["9horas"] = "db9f9deaairwebatMYSQL5014site4";
		$connectionsIds["hoje"] = "db9f9deaairwebatMYSQL5014site4";
		$connectionsIds["ind40_users"] = "db9f9deaairwebatMYSQL5014site4";
		$connectionsIds["admin_rights"] = "db9f9deaairwebatMYSQL5014site4";
		$connectionsIds["admin_members"] = "db9f9deaairwebatMYSQL5014site4";
		$connectionsIds["admin_users"] = "db9f9deaairwebatMYSQL5014site4";
		$connectionsIds["hoje Chart"] = "db9f9deaairwebatMYSQL5014site4";
		$connectionsIds["9horas Chart"] = "db9f9deaairwebatMYSQL5014site4";
		$connectionsIds["6horas Chart"] = "db9f9deaairwebatMYSQL5014site4";
		$connectionsIds["3horas Chart"] = "db9f9deaairwebatMYSQL5014site4";
		$connectionsIds["12horas Chart"] = "db9f9deaairwebatMYSQL5014site4";
		$connectionsIds["24horas Chart"] = "db9f9deaairwebatMYSQL5014site4";
		$connectionsIds["vwv_monitoramento_por_periodo_leitura_max_min_med Chart"] = "db9f9deaairwebatMYSQL5014site4";
