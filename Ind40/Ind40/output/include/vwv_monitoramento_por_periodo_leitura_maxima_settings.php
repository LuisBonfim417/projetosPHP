...
$tdatavwv_monitoramento_por_periodo_leitura_maxima[".pagesByType"] = my_json_decode( "{\"export\":[\"export\"],\"import\":[\"import\"],\"list\":[\"list\"],\"print\":[\"print\"],\"search\":[\"search\"]}" );
...
$tdatavwv_monitoramento_por_periodo_leitura_maxima[".pages"] = types2pages( my_json_decode( "{\"export\":[\"export\"],\"import\":[\"import\"],\"list\":[\"list\"],\"print\":[\"print\"],\"search\":[\"search\"]}" ) );
$tdatavwv_monitoramento_por_periodo_leitura_maxima[".originalPages"] = $tdatavwv_monitoramento_por_periodo_leitura_maxima[".pages"];
$tdatavwv_monitoramento_por_periodo_leitura_maxima[".defaultPages"] = my_json_decode( "{\"export\":\"export\",\"import\":\"import\",\"list\":\"list\",\"print\":\"print\",\"search\":\"search\"}" );
...
$tdatavwv_monitoramento_por_periodo_leitura_maxima[".listAjax"] = false;
	...
	$tdatavwv_monitoramento_por_periodo_leitura_maxima[".audit"] = true;
...
$tdatavwv_monitoramento_por_periodo_leitura_maxima[".badgeColor"] = "9ACD32";
