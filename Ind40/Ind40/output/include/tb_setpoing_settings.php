...
$tdatatb_setpoing[".OwnerID"] = "MON_TAG";
...
if(mlang_getcurrentlang()=="Portuguese(Brazil)")
{
	...
	$fieldLabelstb_setpoing["Portuguese(Brazil)"]["SET_BLOQUEADO"] = "SET BLOQUEADO";
	$fieldToolTipstb_setpoing["Portuguese(Brazil)"]["SET_BLOQUEADO"] = "";
	$placeHolderstb_setpoing["Portuguese(Brazil)"]["SET_BLOQUEADO"] = "";
	$fieldLabelstb_setpoing["Portuguese(Brazil)"]["SET_OBS"] = "SET OBS";
...
$tdatatb_setpoing[".nSecOptions"] = 1;

$tdatatb_setpoing[".mainTableOwnerID"] = "MON_TAG";
...
$tdatatb_setpoing[".listAjax"] = false;
	...
	$tdatatb_setpoing[".locking"] = false;
...
if( $pages[PAGE_EDIT] ) {
	...
	$tdatatb_setpoing[".afterEditActionDetTable"] = "";
}
...
$tdatatb_setpoing[".badgeColor"] = "6DA5C8";
...
//	tb_monitoramento
		...
		$dIndex = 3;
	$detailsParam = array();
	$detailsParam["dDataSourceTable"]="tb_monitoramento";
		$detailsParam["dOriginalTable"] = "tb_monitoramento";



		
		$detailsParam["dType"]=PAGE_LIST;
	$detailsParam["dShortTable"] = "tb_monitoramento";
	$detailsParam["dCaptionTable"] = GetTableCaption("tb_monitoramento");
	$detailsParam["masterKeys"] =array();
	$detailsParam["detailKeys"] =array();
