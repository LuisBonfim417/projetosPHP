...
function checkTableName($shortTName )
{
	...
	if ("tb_setpoing" == $shortTName )
		return true;
	if ("tb_setpoint_bloqueia" == $shortTName )
		return true;
	if ("tb_setpoint_email" == $shortTName )
		return true;
	if ("tb_setpoint_sms" == $shortTName )
		return true;
	if ("tb_monitoramento" == $shortTName )
		return true;
	if ("vwv_analise_temp_maximo_acima" == $shortTName )
		return true;
	if ("vwv_analise_temp_minima_abaixo" == $shortTName )
		return true;
	if ("vwv_monitoramento_por_periodo" == $shortTName )
		return true;
	if ("vwv_monitoramento_por_periodo_leitura_max_min_med" == $shortTName )
		return true;
	if ("vwv_monitoramento_por_periodo_leitura_maxima" == $shortTName )
		return true;
	if ("vwv_monitoramento_por_periodo_leitura_minima" == $shortTName )
		return true;
	if ("vwv_tag_user" == $shortTName )
		return true;
	if ("12horas" == $shortTName )
		return true;
	if ("24horas" == $shortTName )
		return true;
	if ("3horas" == $shortTName )
		return true;
	if ("6horas" == $shortTName )
		return true;
	if ("9horas" == $shortTName )
		return true;
	if ("hoje" == $shortTName )
		return true;
	if ("ind40_users" == $shortTName )
		return true;
	...
	if ("admin_users" == $shortTName )
		return true;
	if ("hoje_chart" == $shortTName )
		return true;
	if ("9horas_chart" == $shortTName )
		return true;
	if ("6horas_chart" == $shortTName )
		return true;
	if ("3horas_chart" == $shortTName )
		return true;
	if ("12horas_chart" == $shortTName )
		return true;
	if ("24horas_chart" == $shortTName )
		return true;
	if ("vwv_monitoramento_por_periodo_leitura_max_min_med_chart" == $shortTName )
		return true;
	return false;
}
...
function GetTablesList($pdfMode = false)
{
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tb_setpoing");
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tb_setpoint_bloqueia");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="tb_setpoint_bloqueia";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tb_setpoint_email");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="tb_setpoint_email";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tb_setpoint_sms");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tb_monitoramento");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="tb_monitoramento";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("vwv_analise_temp_maximo_acima");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="vwv_analise_temp_maximo_acima";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("vwv_analise_temp_minima_abaixo");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="vwv_analise_temp_minima_abaixo";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("vwv_monitoramento_por_periodo");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="vwv_monitoramento_por_periodo";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("vwv_monitoramento_por_periodo_leitura_max_min_med");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="vwv_monitoramento_por_periodo_leitura_max_min_med";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("vwv_monitoramento_por_periodo_leitura_maxima");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="vwv_monitoramento_por_periodo_leitura_maxima";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("vwv_monitoramento_por_periodo_leitura_minima");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="vwv_monitoramento_por_periodo_leitura_minima";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("vwv_tag_user");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("12horas");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("24horas");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("3horas");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("6horas");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("9horas");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("hoje");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("ind40_users");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("hoje Chart");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("9horas Chart");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("6horas Chart");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("3horas Chart");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("12horas Chart");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("24horas Chart");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("vwv_monitoramento_por_periodo_leitura_max_min_med Chart");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="vwv_monitoramento_por_periodo_leitura_max_min_med Chart";
	}
	return $arr;
}
...
{
	if($shorttable=="hoje_chart")
		return "Line";
	if($shorttable=="9horas_chart")
		return "Line";
	if($shorttable=="6horas_chart")
		return "Line";
	if($shorttable=="3horas_chart")
		return "Line";
	if($shorttable=="12horas_chart")
		return "Line";
	if($shorttable=="24horas_chart")
		return "Line";
	if($shorttable=="vwv_monitoramento_por_periodo_leitura_max_min_med_chart")
		return "Line";
	return "";
}
...
function ReadUserPermissions($userID = "")
{
	...
	if($userID != "Guest")
	{
		...
		$sql = "select ".$gConn->addFieldWrappers( "GroupID" )
			...
			." from ". $gConn->addTableWrappers( "aircontrolweb_dyperugmembers" )
	...
	$sql = "select ". $gConn->addFieldWrappers( "TableName" )
		...
		." from ". $gConn->addTableWrappers( "aircontrolweb_dyperugrights" )
...
function GetUserPermissionsStatic( $table )
{
	...
	if( $table=="tb_setpoing" )
	{
		if( $sUserGroup=="Operacional" )
		{
...
//	default permissions
	...
	if( $table=="vwv_analise_temp_maximo_acima" )
	{
		if( $sUserGroup=="Operacional" )
		{
			return "AEDSPI".$extraPerm;
...
//	default permissions
	...
	if( $table=="vwv_analise_temp_minima_abaixo" )
	{
		if( $sUserGroup=="Operacional" )
		{
			return "AEDSPI".$extraPerm;
...
//	default permissions
	...
	if( $table=="vwv_monitoramento_por_periodo" )
	{
		if( $sUserGroup=="Operacional" )
		{
			return "AEDSPI".$extraPerm;
...
//	default permissions
	...
	if( $table=="vwv_monitoramento_por_periodo_leitura_max_min_med" )
	{
		if( $sUserGroup=="Operacional" )
		{
			return "AEDSPI".$extraPerm;
...
//	default permissions
	...
	if( $table=="vwv_monitoramento_por_periodo_leitura_maxima" )
	{
		if( $sUserGroup=="Operacional" )
		{
			return "AEDSPI".$extraPerm;
...
//	default permissions
	...
	if( $table=="vwv_monitoramento_por_periodo_leitura_minima" )
	{
		if( $sUserGroup=="Operacional" )
		{
			return "AEDSPI".$extraPerm;
...
//	default permissions
	...
	if( $table=="vwv_monitoramento_por_periodo_leitura_max_min_med Chart" )
	{
		if( $sUserGroup=="Operacional" )
		{
			return "S".$extraPerm;
...
function SetAuthSessionData($pUsername, &$data, $password, &$pageObject = null, $fireEvents = true )
{
	...
	$_SESSION["_tb_setpoing_OwnerID"] = $data["active"];
