...
if(mlang_getcurrentlang()=="Portuguese(Brazil)")
{
	...
	$fieldLabelstb_setpoint_sms["Portuguese(Brazil)"]["MON_TAG"] = "MON TAG";
	$fieldToolTipstb_setpoint_sms["Portuguese(Brazil)"]["MON_TAG"] = "";
	$placeHolderstb_setpoint_sms["Portuguese(Brazil)"]["MON_TAG"] = "";
	$fieldLabelstb_setpoint_sms["Portuguese(Brazil)"]["SET_SMS"] = "SET SMS";
...
$tdatatb_setpoint_sms[".listAjax"] = false;
	...
	$tdatatb_setpoint_sms[".locking"] = false;
...
$tdatatb_setpoint_sms[".badgeColor"] = "9acd32";
