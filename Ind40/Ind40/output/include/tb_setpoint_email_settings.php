...
if(mlang_getcurrentlang()=="Portuguese(Brazil)")
{
	...
	$fieldLabelstb_setpoint_email["Portuguese(Brazil)"]["MON_TAG"] = "MON TAG";
	$fieldToolTipstb_setpoint_email["Portuguese(Brazil)"]["MON_TAG"] = "";
	$placeHolderstb_setpoint_email["Portuguese(Brazil)"]["MON_TAG"] = "";
	$fieldLabelstb_setpoint_email["Portuguese(Brazil)"]["SET_EMAIL"] = "SET EMAIL";
...
$tdatatb_setpoint_email[".listAjax"] = false;
	...
	$tdatatb_setpoint_email[".locking"] = false;
...
$tdatatb_setpoint_email[".badgeColor"] = "8fbc8b";
