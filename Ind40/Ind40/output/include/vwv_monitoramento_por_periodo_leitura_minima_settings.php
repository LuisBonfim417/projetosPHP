...
$tdatavwv_monitoramento_por_periodo_leitura_minima[".pagesByType"] = my_json_decode( "{\"export\":[\"export\"],\"import\":[\"import\"],\"list\":[\"list\"],\"print\":[\"print\"],\"search\":[\"search\"]}" );
...
$tdatavwv_monitoramento_por_periodo_leitura_minima[".pages"] = types2pages( my_json_decode( "{\"export\":[\"export\"],\"import\":[\"import\"],\"list\":[\"list\"],\"print\":[\"print\"],\"search\":[\"search\"]}" ) );
$tdatavwv_monitoramento_por_periodo_leitura_minima[".originalPages"] = $tdatavwv_monitoramento_por_periodo_leitura_minima[".pages"];
$tdatavwv_monitoramento_por_periodo_leitura_minima[".defaultPages"] = my_json_decode( "{\"export\":\"export\",\"import\":\"import\",\"list\":\"list\",\"print\":\"print\",\"search\":\"search\"}" );
...
$tdatavwv_monitoramento_por_periodo_leitura_minima[".listAjax"] = false;
	...
	$tdatavwv_monitoramento_por_periodo_leitura_minima[".audit"] = true;
...
$tdatavwv_monitoramento_por_periodo_leitura_minima[".badgeColor"] = "D2AF80";
