...
require_once("include/vwv_analise_temp_maximo_acima_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "vwv_analise_temp_maximo_acima" );
